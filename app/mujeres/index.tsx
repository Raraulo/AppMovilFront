  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(`✅ Productos cargados: ${mujeres.length} para mujeres`);
      } catch (error) {
          ...
          ListHeaderComponent={
            <>
              ...
              <View style={styles.titleContainer}>
                <Text style={styles.title}>COLECCIÓN MUJERES</Text>
                <View style={styles.titleDivider} />
                <Text style={styles.subtitle}>Fragancias femeninas de lujo</Text>
              </View>
