  ...
  useEffect(() => {
    const fetchProductos = async () => {
      try {
        ...
        const productosMujeres = data.filter((p: any) => p.genero === 'Mujer');
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <Image
          source={{
            uri: 'https://media.tenor.com/AxH4sa_tLnQAAAAi/chalice-heartwrencher.gif',
          }}
        ...
        {/* Título principal */}
        <Text style={[styles.title, { marginTop: 60 }]}>Parfums Pour Mesdames</Text>
