...
// ✨ TARJETA ANIMADA MEJORADA + HEART COMO EN HOMBRES
const AnimatedCard = ({
  item,
  index,
  onPress,
  ...
  // 🔥 Animación local del heart en la tarjeta (sin toast, igual que Hombres)
    ...
    >
      ...
      >
        <View style={styles.cardImageContainer}>
          ...
          {/* ❤️ Heart igual que en HombresScreen */}
          <TouchableOpacity
...
export default function FavoritosScreen() {
  ...
  // 🔥 Mismo comportamiento lógico que ya tenías, sin toast
  const handleToggleFavorite = async (id: number) => {
    try {
      await removeFromFavorites(id);
      const updated = await getFavorites();

      // Animación del corazón del MODAL (igual que ya tenías)
      Animated.sequence([
        Animated.timing(heartScale, {
          toValue: 0.88,
          duration: 100,
  ...
  // ✨ Detectar cambio de índice al hacer scroll en el modal
  ...
  // ✨ Renderizar cada producto en el modal
