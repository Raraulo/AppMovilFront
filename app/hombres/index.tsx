...
const AnimatedProductCard = ({ item, index, onPress, onToggleFavorite, isFavorite }: any) => {
...
const tipoEquivalencias: Record<number, string> = {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(`✅ Productos cargados: ${hombres.length} para hombres`);
      } catch (error) {
  ...
  try {
    ...
    // ❌ NINGÚN TOAST - Eliminado completamente
          ...
          ListHeaderComponent={
            <>
              ...
              <View style={styles.titleContainer}>
                <Text style={styles.title}>COLECCIÓN HOMBRES</Text>
                <View style={styles.titleDivider} />
                <Text style={styles.subtitle}>Fragancias masculinas de lujo</Text>
              </View>
